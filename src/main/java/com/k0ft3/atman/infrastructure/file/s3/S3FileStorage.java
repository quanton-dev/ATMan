package com.k0ft3.atman.infrastructure.file.s3;
...
import com.k0ft3.atman.domain.common.file.AbstractBaseFileStorage;
import com.k0ft3.atman.domain.common.file.FileStorageException;
...
public class S3FileStorage extends AbstractBaseFileStorage {
    ...
    public String saveUploaded(String folder, MultipartFile multipartFile) {
        ...
        try {
            ...
            log.error("Failed to save file to s3", e);
            throw new FileStorageException("Failed to save file `" + multipartFile.getOriginalFilename() + "` to s3",
                    e);
        }
