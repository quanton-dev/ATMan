...
public class Activity extends AbstractBaseEntity {
    ...
    private Activity(UserId userId, @Nullable CardId cardId, BoardId boardId, ActivityType type, String detail,
            IpAddress ipAddress) {
    ...
    public boolean equals(Object o) {
        ...
        return userId == activity.userId && type == activity.type && Objects.equals(cardId, activity.cardId)
                ...
                && Objects.equals(ipAddress, activity.ipAddress) && Objects.equals(createdDate, activity.createdDate);
    }
    ...
    public String toString() {
        return "Activity{" + "id=" + id + ", userId=" + userId + ", cardId=" + cardId + ", boardId=" + boardId
                + ", type=" + type + ", detail='" + detail + '\'' + ", ipAddress='" + ipAddress + '\''
