...
import com.k0ft3.atman.web.payload.AddBoardMemberPayload;
import com.k0ft3.atman.web.payload.CreateBoardPayload;
import com.k0ft3.atman.web.results.ApiResult;
import com.k0ft3.atman.web.results.BoardResult;
import com.k0ft3.atman.web.results.CreateBoardResult;
...
public class BoardApiController extends AbstractBaseController {
    ...
    public BoardApiController(BoardService boardService, TeamService teamService, CardListService cardListService,
            CardService cardService, FileUrlCreator fileUrlCreator) {
    ...
    public ResponseEntity<ApiResult> addMember(@PathVariable("boardId") long rawBoardId,
        ...
        try {
            ...
            ApiResult apiResult = ApiResult.blank().add("id", member.getId().value()).add("shortName",
                    member.getInitials());
