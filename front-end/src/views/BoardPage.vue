                ...
                <div class="list">
                  ...
                  >
                    <div
                      ...
                      @click="openCard(card)"
                    >
                      <div class="cover-image" v-if="card.coverImage">
...
export default {
  ...
  computed: {
    focusedCardList() {
      return (
        this.cardLists.filter(
          cardList => cardList.id === this.openedCard.cardListId
        )[0] || {}
      )
    }
  },
  ...
  methods: {
    loadInitial() {
      ...
      if (this.$route.params.cardId) {
        ...
        this.loadCard(this.$route.params.cardId)
          .then(card => {
    ...
    openCard(card) {
      ...
      this.$router.push({
        name: 'card',
        params: { cardId: card.id, cardTitle: titlePart }
      })
    },
    openCardWindow() {
