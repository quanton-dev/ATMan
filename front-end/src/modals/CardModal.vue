            ...
            <div class="wrapper description-wrapper">
              <div class="wrapper-body">
                ...
                <form
                  ...
                  @submit.prevent="changeCardDescription"
                  v-show="editingDescription"
                >
                  ...
                  <span
                    ...
                    >Cancel</span
                  >
                  <span class="format-support float-right"
                    >Support Markdown</span
                  >
                </form>
                <div
                  class="description"
                  v-show="description && !editingDescription"
                  v-html="descriptionHtml"
                ></div>
              </div>
            </div>
            <div
              class="wrapper attachments-wrapper"
              v-show="attachments.length || uploadingCount"
            >
              <h5>
                ...
                <ul class="list-unstyled">
                  ...
                  >
                    ...
                    <div class="media-body">
                      ...
                      <p class="when">
                        Added {{ when(attachment.createdDate) }} ago
                      </p>
                    </div>
                  </li>
                </ul>
            ...
            <div class="wrapper activities-wrapper">
              ...
              <div class="wrapper-body">
                ...
                >
                  ...
                  <div class="detail" :class="activity.type">
...
export default {
  ...
  methods: {
    changeCardTitle() {
      cardService
        .changeCardTitle(this.cardId, this.title)
        .then(() => {
    ...
    changeCardDescription() {
      cardService
        .changeCardDescription(this.cardId, this.description)
        .then(() => {
    ...
    addComment() {
      cardService
        .addCardComment(this.cardId, this.newComment)
        .then(commentActivity => {
          this.newComment = ''
